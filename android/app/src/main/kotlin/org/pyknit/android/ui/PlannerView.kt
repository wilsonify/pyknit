...
object PlannerSpecs {
    ...
    private fun num(json: JSONObject, key: String): String {
        val v = json.opt(key)
        return when (v) {
    ...
    private fun thousands(n: Any?): String = when (n) {
    ...
    val all: Map<String, PlannerSpec> = listOf(
        PlannerSpec(
            name = "raglan",
            ...
            groups = listOf(
                ...
                "Construction" to listOf(
                    InputSpec("increases_per_round", "Increases per round", "8", choices = listOf(
                        "4" to "4", "8" to "8", "12" to "12", "16" to "16", "20" to "20", "24" to "24",
                    )),
                    InputSpec("increase_frequency", "Increase frequency", "every_other_round", choices = listOf(
                        "Every round" to "every_round", "Every other round" to "every_other_round",
                    )),
                ),
            ),
            stats = { s, _ ->
        ...
        PlannerSpec(
            ...
            groups = listOf(
                "Shaping" to listOf(
                    ...
                    InputSpec("padding_mode", "Padding mode", "after", choices = listOf(
                        "After" to "after", "Before" to "before", "Both" to "both", "None" to "none",
                    )),
                ),
            ),
            stats = { s, r ->
        ...
        PlannerSpec(
            ...
            groups = listOf(
                "Project" to listOf(
                    InputSpec("project_type", "Project type", "hat", choices = listOf(
                        "Hat / Beanie" to "hat",
                        "Scarf / Cowl" to "scarf",
                ...
                "Pace" to listOf(
                    InputSpec("knitting_pace", "Knitting pace", "medium", choices = listOf(
    ...
    fun forName(name: String): PlannerSpec = all[name]
...
class ResultsPanel(
    ...
    fun showPlaceholder() {
        ...
        card.addView(activity.textView(
            ...
            sizeSp = 14f, colorAttr = MR.attr.colorOnSurfaceVariant,
        ))
    ...
    fun showResult(payload: JSONObject) {
        ...
        if (payload.has("sim_plan")) {
            ...
            card.addView(activity.filledButton(
...
object PlannerView {
    ...
    fun build(
        ...
        fun addInput(column: LinearLayout, input: InputSpec) {
            ...
            column.addView(holder, LinearLayout.LayoutParams(
        ...
        inputsColumn.addView(calculateButton, LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT).apply {
            topMargin = activity.dp(10)
        })
        ...
        resultsColumn.addView(resultsContainer, LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT))

        val body: View = if (activity.isWideScreen) {
            ...
            inputsColumn.addView(resultsColumn, LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT))
            inputsColumn
        }
