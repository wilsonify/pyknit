...
Quick reference for all 13 interactive tools.
...
| Tool | Purpose | Key Inputs |
|------|---------|------------|
| [Even Shaping](../../demos/even-shaping/demo.html) | Space increases/decreases evenly | Operation, stitch count, number |

## Calculate and Convert

| Tool | Purpose | Key Inputs |
|------|---------|------------|
| [Gauge Conversion](../../demos/gauge-conversion/demo.html) | Convert measurements between gauges | Both gauges, measurement |
| [Yarn & Time Estimator](../../demos/yarn-estimator/demo.html) | Estimate yardage and time | Project type, dimensions, gauge |

## Choose Your Materials

| Tool | Purpose | Key Inputs |
|------|---------|------------|
| [Yarn Advisor](../../demos/yarn-advisor/demo.html) | Yarn weight and fiber recommendations | Project, drape, warmth preferences |
| [Needle Advisor](../../demos/needle-advisor/demo.html) | Needle size and type recommendations | Yarn weight, gauge, construction |
